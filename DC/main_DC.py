...
from utils_backup import get_loops, get_dataset, get_network, get_eval_pool, evaluate_synset, get_daparam, match_loss, get_time, TensorDataset, epoch, DiffAugment, ParamDiffAug, FlushFile
import sys
...
def main():
    ...
    log_file = os.path.join(args.save_path, 'log_%s_%s_%s_%dipc.txt' % (args.method, args.dataset, args.model, args.ipc))
