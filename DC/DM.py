...
def main():
    ...
    parser.add_argument('--contrastType', type=str, default='InfoNCE', help='the Type of Contrast Loss')
    ...
    model_args = f'{args.method}_{args.dataset}_{args.model}_{args.ipc}ipc_[{args.feat_metric}{args.lbd}_pool{args.pooling}_layer{args.layer_idx}_CE{args.feat_lbd}_opt{args.feat_opt}_nfeat{args.n_feat}_use{args.use_feature}_norm{args.feat_norm}]_{args.img_method}_init{args.init}_featureFlag{args.feat_flag}'
    if args.contrast:
        model_args += f'_contrast{args.contrastType}{args.lbd_contrast}'
    else:
    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
                    ...
                    for c in range(num_classes):
                        ...
                        if args.contrast:
                            ...
                            if args.contrastType == "InfoNCE":
                                ...
                                loss_adv = sup_con_loss(feature_syn[feat_idx].clone(), label_syn, c)
            ...
            loss_avg_feature_matching /= (num_classes)
            loss_avg_feature_cls /= (num_classes)
            acc_avg_feat /= (num_classes*args.ipc)
