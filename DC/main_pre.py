...
def main():
    ...
    if args.img_method == 'Kmeans':
        load_path = osp.join(args.img_path, args.img_method,f'{args.dataset}_IPC{args.ipc}_images.pt')
    if args.img_method == 'Random':
        load_path = osp.join(args.img_path, args.img_method,f'{args.dataset}_IPC{args.ipc}_normalize_images.pt')
