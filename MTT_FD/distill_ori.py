...
from utils_ori import get_dataset, get_network, get_eval_pool, evaluate_synset, get_time, DiffAugment, ParamDiffAug,FlushFile,epoch
# import wandb
import copy
import random
...
if __name__ == '__main__':
    ...
    model_args = f'origin{args.dataset}_{args.ipc}ipc__{get_time()}'
