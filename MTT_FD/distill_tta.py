...
from utils_tta import get_dataset, get_network, get_eval_pool, evaluate_synset, get_time, DiffAugment, ParamDiffAug,FlushFile,evaluate_synset_w_feature,TensorDataset,epoch
# import wandb
import copy
import random
...
if __name__ == '__main__':
    ...
    # === TTA (test-time augmentation) options, aligned with DCmain3.0.py ===
    parser.add_argument('--tta', action='store_true', default=False,
                        help='Enable test-time augmentation (TTA) in evaluation')
    parser.add_argument('--tta_mode', type=str, default='hflip',
                        choices=['hflip', 'fivecrop', 'hflip5'],
                        help="TTA mode: 'hflip' (horizontal flip), 'fivecrop' (5-crop), or 'hflip5' (flip + 5-crop)")
