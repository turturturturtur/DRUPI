...
parser.add_argument('--img-method',default='IDC',help='image distillation method')
...
parser.add_argument('--inner_loop', type=int, default=10, help='number of inner iteration')
