...
class SynthesizerFeature():
    ...
    def init(self, args, loader,val_loader, logger,init_type='mix'):
        ...
        if init_type == 'random':
            ...
            load_path = osp.join(args.img_path, 'IDC', args.dataset, f'IPC{args.ipc}')
            ...
            image_syn_pretrained = torch.load(osp.join(load_path, f'data_ours.pt'))[0].to(self.device)
            ...
            # print(label_syn.shape)
            # print(feature_syn.shape)
            # # print("start  test_with_features in synset.init")
            # # self.test_with_features(args, val_loader, nn.MSELoss(),logger)
            # print("===================================")
            # print("===================================")
            ...
            # print("start  test_without_features in synset.init")
            # self.test(args,val_loader,logger)
            # print("===================================")
            # print("===================================")
...
def condense(args, logger, device='cuda'):
    ...
    for it in range(n_iter):
        ...
        for ot in range(args.inner_loop):
            ...
            # current_time_inner_loop = datetime.now()
            # print(current_time_inner_loop,"=================== inner_loop")
            ...
            for c in range(nclass):
                ...
                ts.stamp("data")
                # print("===========")
                # print(img_syn.requires_grad)
                # print(lab_syn.requires_grad)
                # print("===========")
                ...
                optim_img.step()
                ts.stamp("backward")
            # current_time_nclass = datetime.now()
            # print(current_time_nclass-current_time_inner_loop,"=================== nclass")
            ...
            if args.n_data > 0:
                ...
                for _ in range(args.net_epoch):
                    ...
                    # current_time_net_epoch = datetime.now()
                    # print(current_time_net_epoch-current_time_nclass,"=================== net_epoch")
            ts.stamp("net update")
