...
def condense(args, logger, device='cuda'):
    ...
    # print('synset shape',synset.shape)
    print('synset data, sunset data data',synset.data.shape, synset.data.data.shape)
    ...
    for it in range(n_iter):
        ...
        for ot in range(args.inner_loop):
            ...
            for c in range(nclass):
                ...
                if ot == 0 and c == 0:
                    print('img shape,lab shape',img.shape, lab.shape)
                    print('img_syn shape,lab_syn shape',img_syn.shape, lab_syn.shape)
                ts.stamp("data")
